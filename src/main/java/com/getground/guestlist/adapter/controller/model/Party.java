...
public class Party {
    ...
    public Party(@NonNull final com.getground.guestlist.usecase.model.Party party) {
        this(party.getId(), party.getName(), party.getPlace(), party.getTables().stream().map(Table::new).collect(toList()));
    }
